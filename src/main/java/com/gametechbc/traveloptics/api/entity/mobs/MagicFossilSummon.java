        ...
        if (reason != null && (livingEntity = this.getSummoner()) instanceof ServerPlayer) {
            ...
            if (reason.shouldDestroy()) {
                ...
                if (reason.equals((Object)Entity.RemovalReason.DISCARDED)) {
                    player.sendSystemMessage((Component)Component.selector((String)"ui.traveloptics.fossil_summon_despawn_message", (Object[])new Object[]{((Entity)this).getDisplayName()}));
                }
            }
        }
    }
