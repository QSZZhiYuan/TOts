...
implements UniqueItem {
    ...
    public void resolvePage(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"item.traveloptics.infernal_devastator.evo_two.active.tooltip"));
            tooltip.add((Component)Component.translatable((String)"item.traveloptics.infernal_devastator.evo_three.active.tooltip"));
        } else {
