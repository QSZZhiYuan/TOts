...
extends MechanizedWraithbladeItem {
    ...
    protected float calculateFinalLaserDamage(float baseDamage, LivingEntity entity) {
        ...
        double spellPowerMultiplier = entity.getStandingEyeHeight(lightningSpellPower);
    ...
    public void resolvePage(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        tooltip.add((Component)Component.translatable((String)"item.traveloptics.mechanized_wraithblade.tooltip2"));
        ...
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"item.traveloptics.mechanized_wraithblade.evo_two.active.tooltip"));
            tooltip.add((Component)Component.translatable((String)"item.traveloptics.mechanized_wraithblade.evo_three.active.tooltip"));
            tooltip.add((Component)Component.score((String)""));
