...
implements UniqueItem {
    ...
    protected int calculateSpiritDamageAmplifier(LivingEntity player) {
        double attackDamage = player.getStandingEyeHeight(Attributes.ATTACK_DAMAGE);
    ...
    public void resolvePage(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            ...
            tooltip.add((Component)Component.translatable((String)"item.traveloptics.gauntlet_of_extinction.evo_two.active.tooltip"));
            tooltip.add((Component)Component.translatable((String)"item.traveloptics.gauntlet_of_extinction.evo_three.active.tooltip"));
        } else {
