...
extends UnbreakableGeoMagicSword {
    ...
    public void resolvePage(ItemStack stack, Level world, List<Component> tooltip, TooltipFlag flag) {
        ...
        if (Screen.hasShiftDown()) {
            tooltip.add((Component)Component.score((String)"\u00a7fEvery \u00a7b7th \u00a7fhit guarantees \u00a7b12 \u00a7fAmethyst Cluster Projectiles, launching in every direction."));
            tooltip.add((Component)Component.score((String)""));
            tooltip.add((Component)Component.score((String)"\u00a7eEvolution Benefits:"));
            tooltip.add((Component)Component.score((String)"\u00a77\u2606 [Evo 1] Decreases swing counter to activate the ability \u00a73-2."));
