...
implements MagicCursedSummon {
    ...
    public void onUnSummon() {
        if (!this.level().isClientSide) {
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)((ParticleOptions)ModParticle.CURSED_FLAME.get()), (double)this.getX(), (double)(this.getY() + 1.8), (double)this.getZ(), (int)35, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.discard();
        }
    }
