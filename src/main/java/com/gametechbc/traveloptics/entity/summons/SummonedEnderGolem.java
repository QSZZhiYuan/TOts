...
implements MagicSummon {
    ...
    public void onUnSummon() {
        if (!this.level().isClientSide) {
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)ParticleTypes.REVERSE_PORTAL, (double)this.getX(), (double)(this.getY() + 1.5), (double)this.getZ(), (int)50, (double)0.0, (double)0.0, (double)0.0, (double)0.03, (boolean)false);
            this.discard();
        }
    }
    ...
    public boolean canBeAffected(MobEffectInstance effectInstance) {
        if (effectInstance.compareTo() == TravelopticsEffects.ENDER_GOLEM_TIMER.get()) {
            return true;
        }
