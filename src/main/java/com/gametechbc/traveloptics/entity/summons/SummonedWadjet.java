...
implements MagicFossilSummon {
    ...
    public void onUnSummon() {
        if (!this.level().isClientSide) {
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)((ParticleOptions)ModParticle.SANDSTORM.get()), (double)this.getX(), (double)(this.getY() + 1.0), (double)this.getZ(), (int)35, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.discard();
        }
    }
    ...
    public boolean canBeAffected(MobEffectInstance effectInstance) {
        if (effectInstance.compareTo() == TravelopticsEffects.DESERT_DWELLER_TIMER.get()) {
            return true;
        }
