...
implements MagicFireSummon {
    ...
    public void onUnSummon() {
        if (!this.level().isClientSide) {
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)ParticleHelper.FIRE, (double)this.getX(), (double)(this.getY() + 2.5), (double)this.getZ(), (int)20, (double)0.0, (double)0.0, (double)0.0, (double)0.3, (boolean)false);
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)ParticleTypes.SMOKE, (double)this.getX(), (double)(this.getY() + 2.5), (double)this.getZ(), (int)45, (double)0.0, (double)0.0, (double)0.0, (double)0.3, (boolean)false);
            this.discard();
        }
    }
    ...
    public boolean canBeAffected(MobEffectInstance effectInstance) {
        if (effectInstance.compareTo() == TravelopticsEffects.IGNITED_ONSLAUGHT_TIMER.get()) {
            return true;
        }
