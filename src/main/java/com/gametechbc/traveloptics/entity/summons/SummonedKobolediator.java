...
implements MagicFossilSummon {
    ...
    public void registerGoals() {
        ...
        this.targetSelector.setControlFlag(4, (Goal)new GenericHurtByTargetGoal((PathfinderMob)this, this::isValidTarget).setAlertOthers(new Class[0]));
    ...
    private boolean isValidTarget(Entity entity) {
        ...
        return server != null && server.maxBlock();
    }
    ...
    public void onUnSummon() {
        if (!this.level().isClientSide) {
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)((ParticleOptions)ModParticle.SANDSTORM.get()), (double)this.getX(), (double)(this.getY() + 1.5), (double)this.getZ(), (int)35, (double)0.4, (double)0.8, (double)0.4, (double)0.03, (boolean)false);
            this.discard();
        }
    }
    ...
    public boolean canBeAffected(MobEffectInstance effectInstance) {
        if (effectInstance.compareTo() == TravelopticsEffects.KOBOLEDIATOR_TIMER.get()) {
            return true;
        }
