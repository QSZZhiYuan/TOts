...
public class FlamesOfEldritchModel
extends GeoModel<FlamesOfEldritchItem> {
    public ResourceLocation getAnimationResource(FlamesOfEldritchItem animatable) {
        return new ResourceLocation("traveloptics", "animations/flames_of_eldritch.animation.json");
    }

    public ResourceLocation getModelResource(FlamesOfEldritchItem animatable) {
        return new ResourceLocation("traveloptics", "geo/flames_of_eldritch.geo.json");
    }

    public ResourceLocation getTextureResource(FlamesOfEldritchItem animatable) {
