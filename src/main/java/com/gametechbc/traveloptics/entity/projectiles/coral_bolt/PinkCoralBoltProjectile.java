...
implements IEntityAdditionalSpawnData {
    ...
    protected void setDangerous(EntityHitResult pResult) {
        if (!this.level().isClientSide) {
            ...
            MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)new BlastwaveParticleOptions(new Vector3f(0.8392f, 0.3294f, 0.6078f), 2.0f), (double)this.getX(), (double)(this.getY() + (double)0.165f), (double)this.getZ(), (int)1, (double)0.0, (double)0.0, (double)0.0, (double)0.0, (boolean)true);
        }
    }
    ...
    public void trailParticles() {
        ...
        for (int i = 0; i < count; ++i) {
            ...
            this.level().addDestroyBlockEffect(TravelopticsParticleHelper.PINK_CORAL_BUBBLE, x - random.z, y + 0.5 - random.multiply, z - random.reverse, random.z * 0.5, random.multiply * 0.5, random.reverse * 0.5);
        }
    }

    public void impactParticles(double x, double y, double z) {
        MagicManager.spawnParticles((Level)this.level(), (ParticleOptions)TravelopticsParticleHelper.PINK_CORAL_SPARKS, (double)x, (double)y, (double)z, (int)15, (double)0.1, (double)0.1, (double)0.1, (double)0.25, (boolean)true);
    }
