...
extends AoeEntity {
    private static final EntityDataAccessor<Boolean> DATA_MIRRORED = SynchedEntityData.assignValue(GyroSlashVisual.class, (EntityDataSerializer)EntityDataSerializers.BOOLEAN);
    LivingEntity target;
