...
extends MobEffect {
    public WetEffect() {
        ...
        this.getAttributeModifierValue((Attribute)AttributeRegistry.LIGHTNING_MAGIC_RESIST.get(), "68078724-8654-42D5-A245-9D14A1F54685", -0.05, AttributeModifier.Operation.MULTIPLY_TOTAL);
        this.getAttributeModifierValue((Attribute)AttributeRegistry.ICE_MAGIC_RESIST.get(), "68078724-8653-42D5-A245-9D14A1F54685", -0.025, AttributeModifier.Operation.MULTIPLY_TOTAL);
    }
